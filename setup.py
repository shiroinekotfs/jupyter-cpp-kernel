...
setup(
      ...
      data_files=[
          ("share/jupyter/kernels/cpp98", ["jupyter-cpp-kernel-98/kernel_spec/logo-64x64.png", "jupyter-cpp-kernel-98/kernel_spec/kernel.json", "jupyter-cpp-kernel-98/kernel_spec/logo-32x32.png", "jupyter-cpp-kernel-98/kernel_spec/logo-svg.svg"]),
