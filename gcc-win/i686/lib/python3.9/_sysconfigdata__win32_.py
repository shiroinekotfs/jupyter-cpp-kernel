...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc-ar.exe',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe',
 'CCSHARED': '',
 ...
 'CONFIG_ARGS': "'--prefix=' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python' "
                ...
                "'CC=/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe' "
                "'PKG_CONFIG_PATH=/d/Prog/winlibs32ucrt_stage/custombuilt/lib/pkgconfig:/d/Prog/winlibs32ucrt_stage/custombuilt/share/pkgconfig'",
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/R/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw/build_win/coverage.info',
 'COVERAGE_REPORT': '/R/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw/build_win/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include -I../PC  -I.',
 'CXX': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-g++.exe',
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cp39-mingw_i686_ucrt.pyd',
 'FILEMODE': 644,
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-g++.exe '
                '-shared -Wl,--enable-auto-image-base',
 'LDFLAGS': '',
 'LDLIBRARY': 'libpython3.9.dll.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe '
             '-shared -Wl,--enable-auto-image-base',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBFFI_INCLUDEDIR': 'D:/Prog/winlibs32ucrt_stage/custombuilt/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 ...
 'LINKCC': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe',
 ...
 'MAINCC': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/i686-w64-mingw32-gcc.exe',
 'MAJOR_IN_MKDEV': 0,
 ...
 'NCURSESW_INCLUDEDIR': 'D:/Prog/winlibs32ucrt_stage/custombuilt/include/ncursesw '
                        '-ID:Progwinlibs32ucrt_stagecustombuiltlibpkgconfig/../../include',
 'NO_AS_NEEDED': '-Wl,--no-as-needed',
 'NT_THREADS': 1,
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-ID:/Prog/winlibs32ucrt_stage/custombuilt/include',
 'OPENSSL_LDFLAGS': '-LD:/Prog/winlibs32ucrt_stage/custombuilt/lib',
 ...
 'VERSION': '3.9',
 'VPATH': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw',
 'VPATH_b2h': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw',
 'WINDOW_HAS_FLAGS': 1,
 'WINDRES': '/d/Prog/winlibs32ucrt_stage/mingw32/bin/windres.exe',
 ...
 'abs_builddir': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw/build_win',
 'abs_builddir_b2h': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw/build_win',
 'abs_srcdir': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw',
 'abs_srcdir_b2h': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw',
 ...
 'prefix': '',
 'prefix_b2h': '',
 'srcdir': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw',
 'srcdir_b2h': 'R:/winlibs32ucrt_stage/cpython-mingw-3.9.7/cpython-mingw'}
