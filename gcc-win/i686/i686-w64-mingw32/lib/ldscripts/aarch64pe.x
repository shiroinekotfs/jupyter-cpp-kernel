...
SEARCH_DIR("/R/winlibs32ucrt_stage/inst_binutils-2.40/share/binutils/aarch64-w64-mingw32/lib"); SEARCH_DIR("/R/winlibs32ucrt_stage/inst_binutils-2.40/share/binutils/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
