...
enum opt_code
{
  ...
  OPT_list = 1889,                           /* -list */
  OPT_m128bit_long_double = 1890,            /* -m128bit-long-double */
  OPT_m16 = 1891,                            /* -m16 */
  OPT_m32 = 1892,                            /* -m32 */
  OPT_m3dnow = 1893,                         /* -m3dnow */
  OPT_m3dnowa = 1894,                        /* -m3dnowa */
  OPT_m64 = 1895,                            /* -m64 */
  OPT_m80387 = 1896,                         /* -m80387 */
  OPT_m8bit_idiv = 1897,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1898,             /* -m96bit-long-double */
  OPT_mabi_ = 1899,                          /* -mabi= */
  OPT_mabm = 1900,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1901,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1902,                 /* -maddress-mode= */
  OPT_madx = 1903,                           /* -madx */
  OPT_maes = 1904,                           /* -maes */
  OPT_malign_data_ = 1905,                   /* -malign-data= */
  OPT_malign_double = 1906,                  /* -malign-double */
  OPT_malign_functions_ = 1907,              /* -malign-functions= */
  OPT_malign_jumps_ = 1908,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1909,                  /* -malign-loops= */
  OPT_malign_stringops = 1910,               /* -malign-stringops */
  OPT_mamx_bf16 = 1911,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1912,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1913,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1914,                      /* -mamx-int8 */
  OPT_mamx_tile = 1915,                      /* -mamx-tile */
  OPT_march_ = 1916,                         /* -march= */
  OPT_masm_ = 1917,                          /* -masm= */
  OPT_mavx = 1918,                           /* -mavx */
  OPT_mavx2 = 1919,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1920,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1921,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1922,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1923,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1924,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1925,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1926,                      /* -mavx512bw */
  OPT_mavx512cd = 1927,                      /* -mavx512cd */
  OPT_mavx512dq = 1928,                      /* -mavx512dq */
  OPT_mavx512er = 1929,                      /* -mavx512er */
  OPT_mavx512f = 1930,                       /* -mavx512f */
  OPT_mavx512fp16 = 1931,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1932,                    /* -mavx512ifma */
  OPT_mavx512pf = 1933,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1934,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1935,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1936,                      /* -mavx512vl */
  OPT_mavx512vnni = 1937,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1938,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1939,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1940,                       /* -mavxifma */
  OPT_mavxneconvert = 1941,                  /* -mavxneconvert */
  OPT_mavxvnni = 1942,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1943,                   /* -mavxvnniint8 */
  OPT_mbmi = 1944,                           /* -mbmi */
  OPT_mbmi2 = 1945,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1946,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1947,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1948,                    /* -mcet-switch */
  OPT_mcld = 1949,                           /* -mcld */
  OPT_mcldemote = 1950,                      /* -mcldemote */
  OPT_mclflushopt = 1951,                    /* -mclflushopt */
  OPT_mclwb = 1952,                          /* -mclwb */
  OPT_mclzero = 1953,                        /* -mclzero */
  OPT_mcmodel_ = 1954,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1955,                     /* -mcmpccxadd */
  OPT_mconsole = 1956,                       /* -mconsole */
  /* OPT_mcpu_ = 1957, */                    /* -mcpu= */
  OPT_mcrc32 = 1958,                         /* -mcrc32 */
  OPT_mcx16 = 1959,                          /* -mcx16 */
  OPT_mdaz_ftz = 1960,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1961,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1962,            /* -mdispatch-scheduler */
  OPT_mdll = 1963,                           /* -mdll */
  ...
  OPT_mgeneral_regs_only = 1981,             /* -mgeneral-regs-only */
  OPT_mgfni = 1982,                          /* -mgfni */
  OPT_mhard_float = 1983,                    /* -mhard-float */
  OPT_mharden_sls_ = 1984,                   /* -mharden-sls= */
  OPT_mhle = 1985,                           /* -mhle */
  OPT_mhreset = 1986,                        /* -mhreset */
  OPT_miamcu = 1987,                         /* -miamcu */
  OPT_mieee_fp = 1988,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1989,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1990,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1991,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1992,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1993,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1994,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1995,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1996, */            /* -mintel-syntax */
  OPT_mkl = 1997,                            /* -mkl */
  OPT_mlam_ = 1998,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 1999,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2000,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2001,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2002,                /* -mlong-double-80 */
  OPT_mlwp = 2003,                           /* -mlwp */
  OPT_mlzcnt = 2004,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2005,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2006,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2007,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2008,                  /* -mmitigate-rop */
  OPT_mmmx = 2009,                           /* -mmmx */
  OPT_mmovbe = 2010,                         /* -mmovbe */
  OPT_mmovdir64b = 2011,                     /* -mmovdir64b */
  OPT_mmovdiri = 2012,                       /* -mmovdiri */
  OPT_mmove_max_ = 2013,                     /* -mmove-max= */
  OPT_mmpx = 2014,                           /* -mmpx */
  OPT_mms_bitfields = 2015,                  /* -mms-bitfields */
  OPT_mmwait = 2016,                         /* -mmwait */
  OPT_mmwaitx = 2017,                        /* -mmwaitx */
  OPT_mneeded = 2018,                        /* -mneeded */
  OPT_mno_align_stringops = 2019,            /* -mno-align-stringops */
  OPT_mno_default = 2020,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2021,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2022,                  /* -mno-push-args */
  OPT_mno_red_zone = 2023,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2024,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 2025,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 2034,            /* -mpe-aligned-commons */
  OPT_mpku = 2035,                           /* -mpku */
  OPT_mpopcnt = 2036,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2037, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2038,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2039,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2040,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2041,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2042,                        /* -mprfchw */
  OPT_mptwrite = 2043,                       /* -mptwrite */
  OPT_mpush_args = 2044,                     /* -mpush-args */
  OPT_mraoint = 2045,                        /* -mraoint */
  OPT_mrdpid = 2046,                         /* -mrdpid */
  OPT_mrdrnd = 2047,                         /* -mrdrnd */
  OPT_mrdseed = 2048,                        /* -mrdseed */
  OPT_mrecip = 2049,                         /* -mrecip */
  OPT_mrecip_ = 2050,                        /* -mrecip= */
  OPT_mrecord_mcount = 2051,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2052,                 /* -mrecord-return */
  OPT_mred_zone = 2053,                      /* -mred-zone */
  OPT_mregparm_ = 2054,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2055,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2056,                           /* -mrtd */
  OPT_mrtm = 2057,                           /* -mrtm */
  OPT_msahf = 2058,                          /* -msahf */
  ...
  OPT_mstv = 2084,                           /* -mstv */
  OPT_mtbm = 2085,                           /* -mtbm */
  OPT_mthreads = 2086,                       /* -mthreads */
  OPT_mtls_dialect_ = 2087,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2088,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2089,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2090,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2091,                         /* -mtune= */
  OPT_muintr = 2092,                         /* -muintr */
  OPT_municode = 2093,                       /* -municode */
  OPT_munroll_only_small_loops = 2094,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2095,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 2096,                          /* -mvaes */
  OPT_mveclibabi_ = 2097,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2098,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2099,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2100,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2101,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2102,                      /* -mwbnoinvd */
  OPT_mwidekl = 2103,                        /* -mwidekl */
  OPT_mwin32 = 2104,                         /* -mwin32 */
  OPT_mwindows = 2105,                       /* -mwindows */
  OPT_mx32 = 2106,                           /* -mx32 */
  OPT_mxop = 2107,                           /* -mxop */
  ...
  OPT_no_pthread = 2117,                     /* -no-pthread */
  OPT_nocpp = 2118,                          /* -nocpp */
  OPT_nodefaultlibs = 2119,                  /* -nodefaultlibs */
  OPT_nolibc = 2120,                         /* -nolibc */
  OPT_nophoboslib = 2121,                    /* -nophoboslib */
  OPT_nostartfiles = 2122,                   /* -nostartfiles */
  OPT_nostdinc = 2123,                       /* -nostdinc */
  OPT_nostdinc__ = 2124,                     /* -nostdinc++ */
  OPT_nostdlib = 2125,                       /* -nostdlib */
  OPT_nostdlib__ = 2126,                     /* -nostdlib++ */
  OPT_o = 2127,                              /* -o */
  OPT_objects = 2128,                        /* -objects */
  OPT_p = 2129,                              /* -p */
  OPT_pass_exit_codes = 2130,                /* -pass-exit-codes */
  /* OPT_pedantic = 2131, */                 /* -pedantic */
  OPT_pedantic_errors = 2132,                /* -pedantic-errors */
  OPT_pg = 2133,                             /* -pg */
  OPT_pie = 2134,                            /* -pie */
  OPT_pipe = 2135,                           /* -pipe */
  OPT_posix = 2136,                          /* -posix */
  OPT_print_file_name_ = 2137,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2138,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2139,          /* -print-multi-directory */
  OPT_print_multi_lib = 2140,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2141,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2142,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2143,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2144,               /* -print-prog-name= */
  OPT_print_search_dirs = 2145,              /* -print-search-dirs */
  OPT_print_sysroot = 2146,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2147,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2148,                    /* -print-value */
  OPT_pthread = 2149,                        /* -pthread */
  OPT_quiet = 2150,                          /* -quiet */
  OPT_r = 2151,                              /* -r */
  OPT_remap = 2152,                          /* -remap */
  OPT_reverse_sort = 2153,                   /* -reverse-sort */
  OPT_s = 2154,                              /* -s */
  OPT_save_temps = 2155,                     /* -save-temps */
  OPT_save_temps_ = 2156,                    /* -save-temps= */
  OPT_shared = 2157,                         /* -shared */
  OPT_shared_libgcc = 2158,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2159,               /* -shared-libphobos */
  OPT_size_sort = 2160,                      /* -size-sort */
  /* OPT_specs = 2161, */                    /* -specs */
  OPT_specs_ = 2162,                         /* -specs= */
  OPT_static = 2163,                         /* -static */
  OPT_static_libasan = 2164,                 /* -static-libasan */
  OPT_static_libgcc = 2165,                  /* -static-libgcc */
  OPT_static_libgfortran = 2166,             /* -static-libgfortran */
  OPT_static_libgm2 = 2167,                  /* -static-libgm2 */
  OPT_static_libgo = 2168,                   /* -static-libgo */
  OPT_static_libhwasan = 2169,               /* -static-libhwasan */
  OPT_static_liblsan = 2170,                 /* -static-liblsan */
  OPT_static_libmpx = 2171,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2172,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2173,               /* -static-libphobos */
  OPT_static_libquadmath = 2174,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2175,               /* -static-libstdc++ */
  OPT_static_libtsan = 2176,                 /* -static-libtsan */
  OPT_static_libubsan = 2177,                /* -static-libubsan */
  OPT_static_pie = 2178,                     /* -static-pie */
  /* OPT_std_c__03 = 2179, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2180, */                /* -std=c++0x */
  OPT_std_c__11 = 2181,                      /* -std=c++11 */
  OPT_std_c__14 = 2182,                      /* -std=c++14 */
  OPT_std_c__17 = 2183,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2184, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2185, */                /* -std=c++1z */
  OPT_std_c__20 = 2186,                      /* -std=c++20 */
  OPT_std_c__23 = 2187,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2188, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2189, */                /* -std=c++2b */
  OPT_std_c__98 = 2190,                      /* -std=c++98 */
  OPT_std_c11 = 2191,                        /* -std=c11 */
  OPT_std_c17 = 2192,                        /* -std=c17 */
  /* OPT_std_c18 = 2193, */                  /* -std=c18 */
  /* OPT_std_c1x = 2194, */                  /* -std=c1x */
  OPT_std_c2x = 2195,                        /* -std=c2x */
  /* OPT_std_c89 = 2196, */                  /* -std=c89 */
  OPT_std_c90 = 2197,                        /* -std=c90 */
  OPT_std_c99 = 2198,                        /* -std=c99 */
  /* OPT_std_c9x = 2199, */                  /* -std=c9x */
  OPT_std_f2003 = 2200,                      /* -std=f2003 */
  OPT_std_f2008 = 2201,                      /* -std=f2008 */
  OPT_std_f2008ts = 2202,                    /* -std=f2008ts */
  OPT_std_f2018 = 2203,                      /* -std=f2018 */
  OPT_std_f95 = 2204,                        /* -std=f95 */
  OPT_std_gnu = 2205,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2206, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2207, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2208,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2209,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2210,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2211, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2212, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2213,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2214,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2215, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2216, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2217,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2218,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2219,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2220, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2221, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2222,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2223, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2224,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2225,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2226, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2227, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2228,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2229, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2230, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2231, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2232, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2233, */         /* -std=iso9899:2018 */
  ...
  OPT_type_stats = 2245,                     /* -type-stats */
  OPT_u = 2246,                              /* -u */
  OPT_undef = 2247,                          /* -undef */
  OPT_v = 2248,                              /* -v */
  OPT_version = 2249,                        /* -version */
  OPT_w = 2250,                              /* -w */
  OPT_wrapper = 2251,                        /* -wrapper */
  OPT_x = 2252,                              /* -x */
  OPT_z = 2253,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
